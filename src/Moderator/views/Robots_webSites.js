...
export default class Robots_webSites extends Component {
    constructor(props) {
        super(props)
            ...
            <div>
                ...
                <div className="container-fluid">
                    ...
                    <div className="col-sm-6">
                        <h1 style={whiteStyle}>WebSites Articles</h1>
                    </div>
                    <div className="col-sm-6">
                        <ol className="breadcrumb float-sm-right">
                        <li className="breadcrumb-item"><a href="/admin_dashboard" style={whiteStyle}>Home</a></li>
                        <li className="breadcrumb-item active" style={whiteStyle}>WebSites Articles</li>
                        </ol>
                    </div>
                    </div>
                </div>{/* /.container-fluid */}
