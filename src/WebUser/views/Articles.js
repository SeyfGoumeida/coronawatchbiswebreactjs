...
export default class Articles extends Component {
  ...
  componentDidMount() {
    //const accessToken = localStorage.getItem("accessToken")
    let url = `${API_URL}/Articles/Validate`;
    axios
      .get(
        url /*, {
        headers: {
  ...
  render() {
    ...
    const { article_list, comment_list, commentcontent , attachments_list} = this.state;
                ...
                <div className="col-sm-6">
                  <ol className="breadcrumb float-sm-right">
                    <li className="breadcrumb-item">
                      <a href="/admin_dashboard" style={whiteStyle}>
                        Home
                      </a>
                    </li>
                    <li className="breadcrumb-item active" style={whiteStyle}>
                      Articles
                    </li>
                  </ol>
                </div>
              ...
              <div className="col-12">
                <div className="card">
                  <div className="card-header">
                    <h5 className="card-title" style={{ color: "#172B4D" }}>
                      Articles
                    </h5>
                  </div>
                  {/* /.card-header */}
                    ...
                    <div className="row">
                      {article_list.length
                        ? article_list.map((post) => (
                            <div className="col-md-12" key={post.idArticle}>
                              {/* Box Comment */}
                              <div className="card card-widget">
                                ...
                                <div className="card-body">
                                  ...
                                  <button
                                    type="button"
                                    onClick={() =>
                                      this.onClickGetComments(post.idArticle)
                                    }
                                    className="btn btn-default btn-sm  "
                                  >
                                    <i className="fas fa-plus"></i> See Comments
                                  </button>
                                        ...
                                        >
                                          ...
                                          <div className="comment-text">
                                            <span className="username">
                                              ...
                                              null ? (
                                                comment.commentEditor.firstName
                                              ) : comment.commentEditor ===
                                                null ? (
                                                <p>User </p>
                                              ) : null}
